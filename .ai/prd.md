...
1. Automatyczne generowanie fiszek:
   ...
   - Fiszki są przedstawiane użytkownikowi w formie stosu kart z możliwością akceptacji, edycji lub odrzucenia. Odbywa się to przez swipowanie kolejnych kart w lewo w celu odrzucenia w prawo w celu zakceptowania oraz w górę w celu edycji aktualnie wyświetlanej karty.
...
3. Podstawowy system uwierzytelniania i kont użytkowników:
   - Rejestracja i logowanie. (Email oraz hasło)
...
1. Poza zakresem MVP:
   ...
   - Aplikacja webowa (obecnie tylko wersja mobilna Android korzystając z Fluttera).
